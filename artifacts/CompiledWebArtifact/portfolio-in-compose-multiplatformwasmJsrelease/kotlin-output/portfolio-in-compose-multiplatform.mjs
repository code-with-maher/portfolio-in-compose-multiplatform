...
import { importObject, setWasmExports } from './portfolio-in-compose-multiplatform.import-object.mjs'
...
const wasmFilePath = './portfolio-in-compose-multiplatform.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./portfolio-in-compose-multiplatform.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
